...
object ApplyAllNode {
  ...
  val listNodes : List[Node] = List(
    Root("h1"),
    Something("h1"),
    SubjectOf("h1", URI("http://some"),QueryVariable("h1")),
    ObjectOf("h1", URI("http://some"),QueryVariable("h1")),
    Value("h1"),
    ...
    DatatypeNode("href",SubjectOf("h1", URI("http://some"),QueryVariable("h1")),"h1"),
    ...
    Rand("h1"),
    Datatype("h1"),
    ProjectionExpression(QueryVariable("aq"),Count(Seq(QueryVariable("q")),distinct = true,"h1"),"h1"),
    Count(Seq(QueryVariable("q")),distinct = false,"h1"),
    //CountAll(true,"h1"),
    Str(URI("s"),"h1"),
    Lang(URI("s"),"h1"),
